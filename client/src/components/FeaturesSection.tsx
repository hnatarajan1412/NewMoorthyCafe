    ...
    <section className="py-16 bg-[#C30010] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white uppercase tracking-wide border-b-4 border-[#FFB800] pb-2 inline-block px-8">Our Specialities</h2>
        </div>
